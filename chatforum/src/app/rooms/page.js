...
export default function Room() {
  // Example room data (replace with your actual data)
  // const rooms = [
  //   { id: 1, name: 'Go', description: 'Discussion for go lang problem here' },
  //   { id: 2, name: 'Python', description: 'Discussion for python problem here' },
  //   { id: 3, name: 'Devops', description: 'Discussion for devops specific tools' },
  //   { id: 4, name: 'JavaScript', description: 'Discussion for Javascript specific problems here' },
  // ];
